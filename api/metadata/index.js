...
app.use('/api/metadata/:post', async (req, res, next) => {
...
app.get('/api/metadata/:post', async (req, res) => {
  const { post } = req.params
...
// boltwall for protected routes
app.use('/api/metadata/:post/tips', boltwall())
 ...
 */
app.put('/api/metadata/:post/tips', async (req, res) => {
  const { post } = req.params
